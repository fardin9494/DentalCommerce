                            ...
                            <div className="flex items-center gap-1">
                              ...
                              >
                                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="m6.25 12.75 2.75 2.75 4.25-5.25" />
                                  <path strokeLinecap="round" strokeLinejoin="round" d="m11 8.75 2.75 2.75L18.25 7" />
                                </svg>
                              </button>
                              <button
