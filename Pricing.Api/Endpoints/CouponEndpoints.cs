...
public static class CouponEndpoints
{
    public static RouteGroupBuilder MapCouponEndpoints(this RouteGroupBuilder group)
    {
        ...
        }).RequirePricingPermission(PricingPermissionKeys.CouponsView);
        ...
        }).RequirePricingPermission(PricingPermissionKeys.CouponsDetailView);
        ...
        coupons.MapGet("/{id:guid}/usage", async (Guid id, Guid? userId, IMediator mediator) =>
        {
            ...
            return result is null ? Results.NotFound() : Results.Ok(result);
        }).RequirePricingPermission(PricingPermissionKeys.CouponsUsageView);
        ...
        coupons.MapGet("/{id:guid}/reservations", async (Guid id, bool? activeOnly, IMediator mediator) =>
        {
            ...
            return Results.Ok(result);
        }).RequirePricingPermission(PricingPermissionKeys.CouponsReservationsView);
        ...
        }).RequirePricingPermission(PricingPermissionKeys.CouponsCreate);
        ...
        coupons.MapPost("/{code}/reserve", async (string code, ReserveCouponBody body, IMediator mediator) =>
        {
            ...
            return Results.Ok(result);
        }).RequirePricingPermission(PricingPermissionKeys.CouponsReserve);
        ...
        }).RequirePricingPermission(PricingPermissionKeys.CouponsEdit);

        coupons.MapDelete("/{id:guid}", async (Guid id, IMediator mediator) =>
        {
            await mediator.Send(new DeleteCouponCommand(id));
            return Results.NoContent();
        }).RequirePricingPermission(PricingPermissionKeys.CouponsDelete);
