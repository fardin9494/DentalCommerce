...
export function BrandsPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Brands">برندها</PageHeader>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  {brands?.map(b => (
                    <tr key={b.id} className="border-b last:border-0">
                      ...
                      <td className="p-2 brand-actions">
                        <PermissionGate permission={CatalogPermissionKeys.BrandsDetailView}>
                          <button className="btn-secondary px-3 py-1.5 rounded" onClick={() => navigate(`/brands/${b.id}`)}>ویرایش</button>
                        </PermissionGate>
                        <PermissionGate permission={CatalogPermissionKeys.BrandsDelete}>
        ...
        <div className="card p-4">
          ...
          <PermissionGate permission={CatalogPermissionKeys.BrandsCreate}>
            <form className="space-y-3" onSubmit={async (e) => {
              ...
              if (rawYear) {
                ...
                if (Number.isNaN(parsedYear)) {
                  swalToastError('سال تاسیس نامعتبر')
                  return
                }
